...
| AKShare `stock_zh_a_daily` / 新浪财经公开行情 | 可建立沪深在市 A 股本地研究基线，不作为正式基线 | `adjust=""` 明确为不复权；2020 年两标的演练已发布。当前网络下东方财富端点不可达，而新浪日线和交易日历可用；新浪通道不覆盖北京市场，当前证券清单还可能遗漏已退市证券。 | 仅限本机、不再分发的沪深研究与回测；manifest 必须披露北京市场缺失和幸存者偏差，不能推广为全 A 股或正式授权基线 |
